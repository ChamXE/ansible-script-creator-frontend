...
function ProjectList () {
    ...
    const column: GridColDef[] = [
        ...
        {
            field: 'routerswitch', headerName: 'Router - Switch Connection', type: 'string', flex: 1, renderCell: () => (
                <Button
                    variant="contained"
                    sx={{ marginLeft: '1rem' }}
        ...
        {
            field: 'switchswitch', headerName: 'Switch - Switch Connection', type: 'string', flex: 1, renderCell: () => (
                <Button
                    variant="contained"
                    sx={{ marginLeft: '1rem' }}
    ...
    const handleEdit = async () => {
        ...
        if(row.size) {
            ...
            setEdit(
                <CreateEditProject resetEdit={resetEdit} newDataIncoming={handleNewDataIncoming} server={server} project={project} />
            );
        }
    }
